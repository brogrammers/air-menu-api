  ...
  module V1
    module Restaurants
      class StaffKindsController < BaseController
        ...
        param :accept_orders, :bool, :desc => 'Staff kind can accept orders', :required => true
        param :accept_order_items, :bool, :desc => 'Staff kind can accept order items', :required => true
